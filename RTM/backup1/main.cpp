...
void drawStuff(void)
{
    ...
    if ( mode == 1 )
    {
        ...
        {
            glColor3f
            ( 0.5 + rdata_c[t+num_t+num_t2*x] * scalar_1
            , 0.5 + vel[t+num_t+num_t2*x] * scalar_4 + rdata_c[t+num_t+num_t2*x] * scalar_2
            , 0.5 + rdata_c[t+num_t+num_t2*x] * scalar_3
            );
            glVertex3f 
            ( -1 + 2.0f * x / num_x
            , 0
    ...
    if ( mode == 2 )
    {
            ...
            )
        {
            ...
            , 0.5 + scalar_4 * vel[t+num_t+num_t2*x] + rdata_c[t+num_t+num_t2*x] * scalar_2
...
void keyboard ( unsigned char key , int x , int y )
{
    switch ( key )
    {
        ...
        case 'r': scalar_4 *= 2 ; break ;
        case 'f': scalar_4 /= 2 ; break ;
        case 't': scalar_1 *= 2 ; scalar_2 *= 2 ; scalar_3 *= 2 ; break ;
        case 'g': scalar_1 /= 2 ; scalar_2 /= 2 ; scalar_3 /= 2 ; break ;
        case 'm': mode = 2 ; 
...
int main( int argc , char ** argv )
{
    ...
    x_frac = get_argument ( arg , argc , argv );

    t_frac = get_argument ( arg , argc , argv );
