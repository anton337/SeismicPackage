...
namespace raytracing
{
    ...
    public:
        ...
        )
        {
            ...
            value_type e_vel ( V . exact_vel ( x1 , y1 , z1 ) );
            value_type e_vel_2 ( e_vel * e_vel );
            ...
            delta_travel_time = //( px*px + py*py + pz*pz ) * e_vel_2;
                                - norm ( px , py , pz )
                                * norm ( vx_out
                                       , vy_out
                                       , vz_out
                                       ); 
            //std::cout << "vel=" << vel_2 << " " << e_vel_2 << std::endl;
    ...
    public:
                        ...
                        )
        {
            ...
            if ( fact == 0 )
            {
                value_type dot ( dx * dvx + dy * dvy + dz * dvz );
                value_type r ( norm ( dx , dy , dz ) );
                if ( r > 1e-8 )
                {
                    dot /= r;
                    dvx = dx * dot;
