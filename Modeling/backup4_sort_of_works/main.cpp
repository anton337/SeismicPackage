        ...
        {
            {
                ...
                if ( x==1&&t==1)
                {
                std::cout << "delta=" << delta[t+x*num_t] << std::endl;
                std::cout << "epsilon=" << epsilon[t+x*num_t] << std::endl;
...
int main( int argc , char ** argv )
{
        ...
        )
    {
            ...
            )
        {
            ...
            p2x[ k ] = 0.05*exp(-disp*disp/(128.0*width))*sin(2*M_PI*disp/(16.0*sqrt(width)));
            p2y[ k ] = 0;
    ...
    float inv_max_w = 10 / ( find_max ( cx , num_x*num_t2 ) + find_max ( cy , num_x*num_t2 ) + find_max ( cz , num_x*num_t2 ) ) ;
