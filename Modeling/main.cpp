        ...
        {
            {
                ...
                vpn_sqr = vp0_sqr * ( 1 + 2 * delta  [t+x*num_t] );
                vs0_sqr = 0;//fact * vs [t+x*num_t] * vs [t+x*num_t];
                cross = sqrtf ( ( vp0_sqr - vs0_sqr ) * ( vpn_sqr - vs0_sqr ) );
                if ( t==1 && x==1 )
                {
                std::cout << "vp0_sqr=" << vp0_sqr << std::endl;
                std::cout << "vpx_sqr=" << vpx_sqr << std::endl;
                std::cout << "vpn_sqr=" << vpn_sqr << std::endl;
                std::cout << "vs0_sqr=" << vs0_sqr << std::endl;
                ...
                //               -     p2z[t+x*num_t]
                //               ;
                //cx[t+x*num_t] = (1+2*epsilon[t+x*num_t]) * vp0_sqr * ( -2*p1x[t+x*num_t] 
                //                          +    p1x[t+(x+1)*num_t]
                //                          +    p1x[t+(x-1)*num_t]
                //                          )
                //              + sqrtf(1+2*delta[t+x*num_t]) * vp0_sqr   * ( -2*p1z[t+x*num_t] 
                //                          +    p1z[t+(x+1)*num_t]
                //                          +    p1z[t+(x-1)*num_t]
                //                          )
                //              + 2 * p1x[t+x*num_t]
                ...
                //                          +    p1z[t-1+x*num_t]
                //                          )
                //              + sqrtf(1+2*delta[t+x*num_t]) * vp0_sqr   * ( -2*p1x[t+x*num_t] 
                //                          +    p1x[t+1+x*num_t]
                //                          +    p1x[t-1+x*num_t]
                //                          )
                //              + 2 * p1z[t+x*num_t]
...
int main( int argc , char ** argv )
{
    ...
    float inv_max_w = 10 / ( find_max ( cx , num_x*num_t2 ) + 0*find_max ( cy , num_x*num_t2 ) + find_max ( cz , num_x*num_t2 ) ) ;
        ...
        )
    {
        ...
        {
            data[k] -= 0.5 * (cx[t+x*num_t2] + 0*cy[t+x*num_t2] + cz[t+x*num_t2]) * max_v * inv_max_w;
        }
    }
