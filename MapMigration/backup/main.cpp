...
int main( int argc , char ** argv )
{
    ...
    for ( int k(0) ; k < num_x ; k += 5 )
    {
        horizon . push_back ( pt ( k , 200 + 50 * sin ( (float)k/100 ) ) );
    }
        ...
        )
    {
            ...
            )
        {
            ...
            {
                tmp_disp = (0.75*sqrtf(pow_2(x-horizon[h].x_pos)+pow_2(t-horizon[h].z_pos)));
                if ( tmp_disp < disp )
                {
                    disp = tmp_disp;
                }
    ...
    for ( int k(0) ; k < frac*num_iter ; ++k )
    {
        ...
        set_wave_scalar    ( 0.4 / find_max ( cx , num_x2 * num_t2 ) );
        set_reverse_scalar ( 0.4 / find_max ( cz , num_x2 * num_t2 ) );
